...
try:
    ...
    while True:
        ...
        display.text("RGB LED", 160, 150, WHITE)
        display.ellipse(190, 120, 20, 20, color565(r, g, b), True)
        
        paint_btn(button.BTN_LEFT, 40, 65, "LEFT", 8)
        paint_btn(button.BTN_RIGHT, 160, 65, "RIGHT", 4)
        paint_btn(button.BTN_UP, 100, 40, "UP", 15)
        paint_btn(button.BTN_DOWN, 100, 90, "DOWN", 8)
        
        paint_btn(button.BTN_X, 100, 65, "X", 18)
        paint_btn(button.BTN_Y, 32, 20, "Y", 18)
        paint_btn(button.BTN_A, 240, 35, "A", 18)
        paint_btn(button.BTN_B, 220, 60, "B", 18)
