...
#define WIDTH_OFFSET   20  // screen starts on the x=20 position of the framebuff
#define SPACE 0x20
...
#define FILECOLW	16	// width of file panel

#define RIGHT_PANEL_WIDTH_OFFSET  (WIDTH_OFFSET + FILECOLW*FONTW)  // 148
#define BITMAP_OFFSET    (RIGHT_PANEL_WIDTH_OFFSET+3)    // 151
#define TXT_OFFSET    (RIGHT_PANEL_WIDTH_OFFSET+2)    // 150

// text of preview (preview field width = 20 characters, height = 15 rows)
#define FONTW2		6	// font width
#define FONTH2		8	// font height
#define TEXTW2		((int)((SCREEN_WIDTH-TXT_OFFSET+WIDTH_OFFSET)/FONTW2)) // number of characters on the right screen (=(280-150+20)/6=25)
