This folder is copied rom the original PicoLibSDK githu repo, then it was
- cleaned up (only the pico10, rp2040 based target device is kept with st7789 display)
- customized for our own hardware (different PINs,rp2040-zero board, 240x280 resolution)
