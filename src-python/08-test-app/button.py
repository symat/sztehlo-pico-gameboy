...
def check_buttons():
    ...
    if (button_last_read != button_current_read and time_since_changed > BOUNTING_CHECK_DELAY_MS) or (time_since_changed > BUTTON_REPEAT_DELAY_MS and (0 in button_current_read)):  
